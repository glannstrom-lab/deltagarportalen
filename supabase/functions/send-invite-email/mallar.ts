...
//
// Två template-funktioner: generell (deltagare) och företagskonto (AG6,
// 2026-09-13 — se avsnittet FÖRETAGSKONTO nedan). Den tredje, STA-mallen,
// togs bort 2026-09-24: STA arkiverades 2026-09-12 och ingen kod skapar
// inbjudningar med metadata.program = 'steg_till_arbete' längre. Mallen finns
// i git-historiken (före 2026-09-24) om texterna någon gång behövs.
...
// Generellt mail — för deltagarinbjudningar
