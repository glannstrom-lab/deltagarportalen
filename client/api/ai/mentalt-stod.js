...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const systemPrompt = 'Du är en stödjande och empatisk coach. Ge uppmuntran och praktiska tips för att hantera jobbsökning på svenska. Var varm och förstående.';
    const userPrompt = `Situation: ${data?.situation || 'Jobbsökning'}\nKänsla: ${data?.kansla || 'Osäker'}\n\nGe emotionellt stöd och konkreta tips för att hantera situationen.`;
