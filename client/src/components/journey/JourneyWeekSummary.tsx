...
export function JourneyWeekSummary({ summary }: JourneyWeekSummaryProps) {
  ...
  return (
    <Card className="p-6 bg-gradient-to-br from-slate-50 to-indigo-50/50">
      <div className="flex items-center gap-2 mb-4">
        <Calendar className="w-5 h-5 text-indigo-600" />
        <h3 className="text-lg font-semibold text-slate-900">Denna vecka</h3>
      </div>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between text-sm mb-2">
          <span className="text-slate-600">Veckans aktivitet</span>
