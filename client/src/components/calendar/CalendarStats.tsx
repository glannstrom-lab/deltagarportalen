...
export function CalendarStats({ events, goals, moodEntries }: CalendarStatsProps) {
  ...
  return (
    <div className="space-y-4">
            ...
            return (
              <div key={type}>
                <div className="flex justify-between text-sm mb-1">
                  <span className="text-stone-600">{labels[type]}</span>
                ...
                <div className="h-2 bg-stone-100 rounded-full overflow-hidden">
                  <div
                    className={`h-full rounded-full transition-all ${
                      progress.percentage >= 100 ? 'bg-green-500' : 'bg-[var(--c-solid)]'
                    }`}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white/10 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-white">Intervjuer</span>
            </div>
          ...
          <div className="bg-white/10 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-white">Möten</span>
            </div>
          ...
          <div className="bg-white/10 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-white">Uppgifter</span>
            </div>
      ...
      {latestMood && (
        <div className="bg-white rounded-xl border border-stone-200 p-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-medium text-stone-900">{getMoodLabel(latestMood.level)}</p>
      ...
      <div className="bg-white rounded-xl border border-stone-200 p-4">
        <h3 className="font-semibold text-stone-900 mb-3">Aktivitetsnivå</h3>
        <div className="flex items-end gap-1 h-16">
          {[...Array(7)].map((_, i) => {
            ...
            const colors = ['bg-stone-100', 'bg-[var(--c-accent)]/60', 'bg-[var(--c-accent)]', 'bg-[var(--c-solid)]', 'bg-[var(--c-solid)]']
            ...
            return (
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                ...
                />
                <span className="text-xs text-stone-600">{dayNames[d.getDay()]}</span>
              </div>
            )
          })}
        </div>
