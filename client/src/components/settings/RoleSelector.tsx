              ...
              <div className="bg-slate-50 rounded-xl p-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-violet-600 text-white rounded-lg font-medium hover:bg-violet-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
