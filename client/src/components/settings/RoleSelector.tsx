  ...
  return (
    <div className="bg-white rounded-xl border border-stone-200 overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        <h4 className="text-sm font-medium text-stone-700">Aktiv roll</h4>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-stone-700 mt-0.5">{config.description}</p>
                </div>

                <div className={cn(
                  'w-6 h-6 rounded-full border-2 flex items-center justify-center',
                  isActive
                    ? 'border-[var(--c-solid)] bg-[var(--c-solid)]'
                    : 'border-stone-300'
                )}>
              ...
              <div className="bg-stone-50 rounded-xl p-4">
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          className="w-4 h-4 text-[var(--c-text)] rounded border-stone-300 focus:ring-[var(--c-solid)]"
                        />
                        <Icon className={cn('w-5 h-5', config.color)} />
                        <div>
                          <span className="font-medium text-stone-900">{config.label}</span>
                          <p className="text-xs text-stone-700">{config.description}</p>
                        </div>
                      </label>
                    )
                  })}
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-[var(--c-solid)] text-white rounded-lg font-medium hover:bg-[var(--c-text)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
