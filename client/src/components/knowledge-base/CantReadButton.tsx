    ...
    <div className="relative">
      ...
      {showMessage && (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-bottom-4">
          <div className="bg-[var(--c-solid)] text-white px-6 py-3 rounded-xl shadow-lg flex items-center gap-3">
      ...
      <button
        ...
        className={cn(
          ...
          isExpanded
            ...
            : "bg-white border-stone-200 hover:border-sky-200 hover:bg-sky-50/50"
        )}
      >
      ...
      {isExpanded && (
        <div className="mt-3 pl-4 space-y-2 animate-in fade-in slide-in-from-top-2">
          <button
            ...
            className="w-full flex items-center gap-3 p-3 rounded-lg bg-white border border-stone-200 hover:border-sky-300 hover:bg-sky-50 transition-all text-left"
          >
            <Bookmark className="w-4 h-4 text-sky-500" />
            <div>
              <p className="font-medium text-stone-800 text-sm">Spara till senare</p>
              <p className="text-xs text-stone-700">Vi påminner dig om ett tag</p>
            </div>
          </button>
          ...
          {onShowShorterAlternative && (
            ...
            >
              ...
              <div>
                <p className="font-medium text-stone-800 text-sm">Visa kortare alternativ</p>
                <p className="text-xs text-stone-700">Artiklar under 3 minuter</p>
              </div>
            </button>
          )}
