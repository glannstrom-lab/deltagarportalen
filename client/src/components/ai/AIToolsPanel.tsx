      ...
      <div className="space-y-4">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[var(--c-accent)]/40 dark:bg-[var(--c-bg)]/50 flex items-center justify-center">
            ...
            {tools.map((tool) => {
              ...
              return (
                <button
                  ...
                  className="flex items-start gap-3 p-3 rounded-xl bg-white dark:bg-stone-800 border border-gray-200 dark:border-stone-700 hover:border-[var(--c-accent)] dark:hover:border-[var(--c-accent)]/60 hover:shadow-sm transition-all text-left"
                >
                  <div className="w-8 h-8 rounded-lg bg-[var(--c-bg)] dark:bg-[var(--c-bg)]/50 flex items-center justify-center flex-shrink-0">
                    <Icon className="w-4 h-4 text-[var(--c-text)] dark:text-[var(--c-solid)]" />
                  </div>
                  <div>
