      ...
      >
        {result && (
          <div className="space-y-4">
            {/* ROI Analysis */}
            <div className="p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-brand-50 dark:from-emerald-900/20 dark:to-brand-900/20 border border-emerald-200 dark:border-emerald-800">
            ...
            {result.learningPath.length > 0 && (
              ...
              >
                <div className="relative pl-4">
                  {/* Timeline line */}
                  <div className="absolute left-1.5 top-2 bottom-2 w-0.5 bg-gradient-to-b from-brand-700 to-sky-500" />

                  <div className="space-y-4">
                    {result.learningPath.map((step) => (
                      <div key={step.step} className="relative flex items-start gap-4">
                        {/* Timeline dot */}
                        <div className="absolute -left-4 w-3 h-3 rounded-full bg-brand-700 ring-4 ring-white dark:ring-slate-900" />
              ...
              >
                <div className="space-y-2">
                  {result.freeCourses.map((course, i) => (
                    <div
                      key={i}
                      className="p-3 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-brand-300 dark:hover:border-brand-900 transition-colors"
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2 text-xs">
                            <span className="px-2 py-0.5 bg-brand-100 dark:bg-brand-900/50 text-brand-900 dark:text-brand-300 rounded-full">
                              {course.provider}
                            </span>
