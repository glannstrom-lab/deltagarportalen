...
const STATUS_CONFIG = {
  ...
  interview: { label: 'Intervju', color: 'violet', icon: MessageSquare },
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 min-h-[80px]"
        ...
        <div className="flex gap-2 flex-wrap">
          <button
            ...
            className={cn(
              ...
              !filter ? "bg-indigo-600 text-white" : "bg-slate-100 text-slate-600 hover:bg-slate-200"
            )}
          >
            Alla
          </button>
              ...
              <Card key={app.id} className="group hover:shadow-md transition-shadow">
                <div className="flex items-start gap-4">
                  <div className={cn(
                    ...
                    status.color === 'violet' && "bg-violet-100 text-violet-600",
