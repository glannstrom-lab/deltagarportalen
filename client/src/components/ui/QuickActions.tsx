...
import { ArrowRight, FileText, Compass, Briefcase } from '@/components/ui/icons'
...
export function QuickActions({ hasCV, hasInterestResult }: QuickActionsProps) {
  ...
  return (
    <div className="card">
      <h3 className="font-semibold text-stone-800 mb-6">Snabbåtgärder</h3>
      <div className="space-y-4">
        {actions.map((action) => (
          ...
          >
            ...
            <ArrowRight size={20} className="text-stone-600 group-hover:text-stone-600" />
          </Link>
        ))}
      </div>
    </div>
