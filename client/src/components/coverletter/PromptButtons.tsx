...
const emotionColors: Record<string, string> = {
  ...
  intresse: 'bg-violet-50 text-violet-700 border-violet-200 hover:bg-violet-100',
  ...
  erfarenhet: 'bg-indigo-50 text-indigo-700 border-indigo-200 hover:bg-indigo-100',
  kompetens: 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100',
