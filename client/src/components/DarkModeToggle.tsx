    ...
    return (
      <button
        ...
        className={cn(
          ...
          'hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-[var(--c-solid)] focus:ring-offset-2',
          sizeClasses[size],
          isDark 
      ...
      <div className={cn(
        ...
        <button
          ...
          className={cn(
            ...
            theme === 'light'
              ? 'bg-white dark:bg-stone-700 text-[var(--c-text)] shadow-sm'
    ...
    <div className={cn('flex items-center gap-2', className)}>
      <button
        ...
        className={cn(
          ...
          'hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-[var(--c-solid)]',
          sizeClasses[size],
          isDark 
