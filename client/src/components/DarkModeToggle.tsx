    ...
    return (
      <button
        ...
        className={cn(
          ...
          'hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-brand-700 focus:ring-offset-2',
          sizeClasses[size],
          isDark 
      ...
      <div className={cn(
        ...
        <button
          ...
          className={cn(
            ...
            theme === 'light'
              ? 'bg-white dark:bg-stone-700 text-brand-900'
    ...
    <div className={cn('flex items-center gap-2', className)}>
      <button
        ...
        className={cn(
          ...
          'hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-brand-700',
          sizeClasses[size],
          isDark 
