...
const categoryInfo = {
  ...
  interview: { label: 'Intervju', color: 'bg-brand-100 text-brand-900 dark:bg-brand-900/40 dark:text-brand-300' },
...
export function GoalCreationDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white dark:bg-stone-900 rounded-xl w-full max-w-3xl max-h-[90vh] overflow-hidden">
        {/* Header */}
        ...
        <div className="p-5 overflow-y-auto max-h-[calc(90vh-180px)]">
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  className={cn(
                    ...
                    'border-2 border-transparent focus:border-brand-700',
              ...
              <div className="space-y-2 max-h-80 overflow-y-auto">
                {filteredParticipants.map(p => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-brand-100 dark:bg-brand-900/40 flex items-center justify-center text-brand-900 dark:text-brand-400 font-medium">
          ...
          {step === 'template' && (
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-3 p-3 bg-brand-50 dark:bg-brand-900/20 rounded-xl">
                  ...
                  {!preselectedParticipant && (
                    <button
                      ...
                      className="ml-auto text-sm text-brand-900 hover:underline"
                    >
                      Ändra
                    </button>
                  )}
              ...
              {/* AI Suggestions */}
              <div className="p-4 bg-gradient-to-r from-brand-50 to-sky-50 dark:from-brand-900/20 dark:to-sky-900/20 rounded-xl">
                  ...
                  <div className="space-y-2">
                    {aiSuggestions.map((suggestion, i) => (
                      <button
                        ...
                        className="w-full text-left p-3 bg-white dark:bg-stone-800 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-colors"
                      >
                        <div className="flex items-center gap-2">
                  ...
                  {goalTemplates.map(template => {
                    ...
                    return (
                      <button
                        ...
                        className="text-left p-4 rounded-xl border-2 border-stone-200 dark:border-stone-700 hover:border-brand-700 transition-colors"
                      >
              ...
              <button
                ...
                className="w-full p-4 rounded-xl border-2 border-dashed border-stone-300 dark:border-stone-600 hover:border-brand-700 transition-colors text-center"
              >
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-4 p-4 bg-stone-50 dark:bg-stone-800/50 rounded-xl">
                <h4 className="font-medium text-stone-900 dark:text-stone-100 flex items-center gap-2">
                  <Target className="w-4 h-4 text-brand-900" />
                  SMART-definition
                </h4>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={cn(
                      ...
                      'border border-stone-200 dark:border-stone-700 focus:border-brand-700',
                      'text-stone-900 dark:text-stone-100'
                    )}
                  />
                </div>
