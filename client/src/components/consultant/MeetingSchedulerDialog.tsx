...
export function MeetingSchedulerDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white dark:bg-stone-900 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        {/* Header */}
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selectedParticipant?.participant_id === p.participant_id &&
                        'bg-brand-50 dark:bg-brand-900/20 ring-2 ring-brand-700'
                    )}
                  >
                  ...
                  {getDaysInMonth(currentMonth).map((date, i) => (
                    <button
                      ...
                      className={cn(
                        ...
                        date && isToday(date) && 'ring-2 ring-brand-700',
                        date && isSelected(date) && 'bg-brand-900 text-white hover:bg-brand-900'
                      )}
                    >
                      {date?.getDate()}
                    </button>
