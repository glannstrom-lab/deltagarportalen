...
function InsightCard({ insight, onAction }: { insight: Insight; onAction?: () => void }) {
  ...
  const colorMap = {
    ...
    suggestion: 'bg-violet-100 dark:bg-violet-900/40 text-violet-600 dark:text-violet-400',
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {insight.participant && (
            <button
              onClick={onAction}
              className="flex items-center gap-1 mt-2 text-xs text-violet-600 dark:text-violet-400 hover:underline"
            >
...
export function AICoachAssistant({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between p-4 bg-gradient-to-r from-violet-600 to-purple-700">
      ...
      <div className="flex border-b border-stone-200 dark:border-stone-700">
        ...
        >
          <div className="flex items-center justify-center gap-2">
            ...
            {insights.length > 0 && (
              <span className="px-1.5 py-0.5 rounded-full bg-violet-100 dark:bg-violet-900/40 text-xs text-violet-600 dark:text-violet-400">
                {insights.length}
              </span>
            )}
          </div>
        ...
        {activeTab === 'insights' ? (
              ...
              <div className="p-4 border-t border-stone-200 dark:border-stone-700">
                ...
                <div className="flex gap-2">
                  {quickActions.map((action, index) => (
                    ...
                    >
                      <action.icon className="w-4 h-4 text-violet-600 dark:text-violet-400" />
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 ? (
                <div className="text-center py-8">
                  <Bot className="w-12 h-12 text-violet-300 dark:text-violet-700 mx-auto mb-3" />
                            ...
                            {message.suggestions.map((suggestion, index) => (
                              <button
                                ...
                                className={cn(
                                  ...
                                  'text-violet-600 dark:text-violet-400',
                                  'hover:bg-violet-50 dark:hover:bg-stone-600',
                                  'transition-colors'
                                )}
                              >
                                {suggestion}
