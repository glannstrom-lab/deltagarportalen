...
function InsightCard({ insight, onAction }: { insight: Insight; onAction?: () => void }) {
  ...
  const colorMap = {
    ...
    suggestion: 'bg-brand-100 dark:bg-brand-900/40 text-brand-900 dark:text-brand-400',
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {insight.participant && (
            <button
              onClick={onAction}
              className="flex items-center gap-1 mt-2 text-xs text-brand-900 dark:text-brand-400 hover:underline"
            >
...
export function AICoachAssistant({
    ...
    return (
      <button
        ...
        className={cn(
          ...
          'bg-gradient-to-br from-brand-900 to-sky-700',
          ' /30',
  ...
  return (
    <div
      className={cn(
        'fixed z-50 bg-white dark:bg-stone-900 rounded-xl',
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between p-4 bg-gradient-to-r from-brand-900 to-sky-700">
      ...
      <div className="flex border-b border-stone-200 dark:border-stone-700">
        <button
          ...
          className={cn(
            ...
            activeTab === 'insights'
              ? 'text-brand-900 dark:text-brand-400 border-b-2 border-brand-900'
        ...
        >
          <div className="flex items-center justify-center gap-2">
            ...
            {insights.length > 0 && (
              <span className="px-1.5 py-0.5 rounded-full bg-brand-100 dark:bg-brand-900/40 text-xs text-brand-900 dark:text-brand-400">
                {insights.length}
              </span>
            )}
          </div>
        ...
        {activeTab === 'insights' ? (
              ...
              <div className="p-4 border-t border-stone-200 dark:border-stone-700">
                ...
                <div className="flex gap-2">
                  {quickActions.map((action, index) => (
                    ...
                    >
                      <action.icon className="w-4 h-4 text-brand-900 dark:text-brand-400" />
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 ? (
                <div className="text-center py-8">
                  <Bot className="w-12 h-12 text-brand-300 dark:text-brand-900 mx-auto mb-3" />
                ...
                <>
                            ...
                            {message.suggestions.map((suggestion, index) => (
                              <button
                                ...
                                className={cn(
                                  ...
                                  'text-brand-900 dark:text-brand-400',
                                  'hover:bg-brand-50 dark:hover:bg-stone-600',
                                  'transition-colors'
                                )}
                              >
                                {suggestion}
                  ...
                  {isLoading && (
                    <div className="flex justify-start">
                      <div className="bg-stone-100 dark:bg-stone-800 rounded-xl rounded-bl-md px-4 py-3">
                        <div className="flex items-center gap-2">
                          <Loader2 className="w-4 h-4 text-brand-900 animate-spin" />
