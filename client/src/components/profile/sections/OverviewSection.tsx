  ...
  return (
    ...
    >
      ...
      {!interestLoading && !interestProfile.hasResult && (
        <Link
          to="/interest-guide"
          className="lg:col-span-2 bg-amber-50 dark:bg-amber-900/20 rounded-2xl p-5 border border-amber-200 dark:border-amber-800/50 flex items-center gap-4 hover:shadow-lg transition-shadow group"
        >
