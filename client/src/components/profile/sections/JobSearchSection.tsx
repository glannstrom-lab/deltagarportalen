...
export function JobSearchSection() {
  ...
  return (
    ...
    >
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-stone-600 dark:text-stone-400 mb-1">
              Max pendling: {preferences.mobility?.maxCommuteMinutes || 45} min
            </label>
            <input
              type="range"
              min={15}
              ...
              aria-label="Max pendlingstid i minuter"
              aria-valuemin={15}
              aria-valuemax={120}
      ...
      <SectionCard title="Stöd jag kan behöva" icon={<AlertCircle className="w-4 h-4" />} colorScheme="amber">
        <div className="space-y-4">
          <ChipSelect
            label="Områden där jag kan behöva stöd"
            ...
            multiple
            hint="Det är helt okej att behöva stöd"
          />
      ...
      {/* Work preferences */}
      <SectionCard title="Arbetspreferenser" icon={<Building2 className="w-4 h-4" />} colorScheme="sky" className="md:col-span-2">
