      ...
      {editing ? (
        <div className="space-y-3">
          <textarea
            ...
            rows={6}
            className="w-full px-4 py-3 bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-600 rounded-xl text-sm text-stone-700 dark:text-stone-300 resize-none focus:outline-none focus:ring-2 focus:ring-[var(--c-solid)]/20 focus:border-[var(--c-solid)]"
          />
          <div className="flex gap-2 justify-end">
            ...
            <button
              onClick={handleSave}
              className="px-3 py-1.5 text-sm font-medium bg-[var(--c-solid)] hover:bg-[var(--c-solid)] text-white rounded-lg transition-colors"
            >
              {t('common.save')}
            </button>
          </div>
