    ...
    <div className={cn('space-y-6', className)}>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <Mail className="w-4 h-4 text-[var(--c-solid)]" />
        ...
        <div className="space-y-2">
          {[
            ...
            <label key={item.key} className="flex items-center justify-between p-3 bg-white dark:bg-stone-800 rounded-lg border border-stone-200 dark:border-stone-700 cursor-pointer hover:border-[var(--c-accent)] dark:hover:border-[var(--c-accent)]/60 transition-colors">
              <div>
              ...
              <input
                ...
                className="w-4 h-4 rounded border-stone-300 dark:border-stone-600 text-[var(--c-solid)] focus:ring-[var(--c-solid)]"
              />
            </label>
          ))}
        </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <Phone className="w-4 h-4 text-[var(--c-solid)]" />
          <h4 className="font-medium text-stone-800 dark:text-stone-200">{t('profile.settings.pushNotifications')}</h4>
        </div>
        <div className="space-y-2">
          <label className="flex items-center justify-between p-3 bg-white dark:bg-stone-800 rounded-lg border border-stone-200 dark:border-stone-700 cursor-pointer hover:border-[var(--c-accent)] dark:hover:border-[var(--c-accent)]/60 transition-colors">
            <div>
      ...
      {saving && (
        <div className="flex items-center gap-2 text-xs text-[var(--c-text)] dark:text-[var(--c-text)]">
...
export function VisibilitySettingsSection({ className }: VisibilitySettingsProps) {
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <Globe className="w-4 h-4 text-[var(--c-solid)]" />
            ...
            <label
              ...
              className={cn(
                ...
                settings.profile_visible_to === item.value
                  ? 'bg-[var(--c-bg)] dark:bg-[var(--c-bg)]/40 border-[var(--c-accent)] dark:border-[var(--c-accent)]/50'
                  : 'bg-white dark:bg-stone-800 border-stone-200 dark:border-stone-700 hover:border-[var(--c-accent)] dark:hover:border-[var(--c-accent)]/60'
              )}
            >
              <input
                type="radio"
                ...
                className="w-4 h-4 border-stone-300 dark:border-stone-600 text-[var(--c-solid)] focus:ring-[var(--c-solid)]"
              />
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <Eye className="w-4 h-4 text-[var(--c-solid)]" />
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <label key={item.key} className="flex items-center gap-2 p-2 bg-white dark:bg-stone-800 rounded-lg border border-stone-200 dark:border-stone-700 cursor-pointer hover:border-[var(--c-accent)] dark:hover:border-[var(--c-accent)]/60 transition-colors">
              <input
                type="checkbox"
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <Building2 className="w-4 h-4 text-[var(--c-solid)]" />
