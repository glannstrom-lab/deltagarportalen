...
const REMINDER_TYPE_CONFIG: Record<ReminderType, {
  ...
  interview: { icon: Users, color: 'text-[var(--c-text)]', bgColor: 'bg-[var(--c-accent)]/40', label: 'Intervju' },
  phone_screen: { icon: Phone, color: 'text-[var(--c-text)]', bgColor: 'bg-[var(--c-accent)]/40', label: 'Telefonintervju' },
  ...
  custom: { icon: Bell, color: 'text-stone-600', bgColor: 'bg-stone-100', label: 'Påminnelse' }
}
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {reminder.description && (
            <p className="text-sm text-stone-600 mt-1">{reminder.description}</p>
          )}
