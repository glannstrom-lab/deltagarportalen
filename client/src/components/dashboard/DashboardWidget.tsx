      ...
      <div className="pt-4 mt-auto border-t border-slate-100 flex gap-2">
        ...
        {secondaryAction && (
          <button
            ...
            className="flex-1 py-2 px-3 border border-slate-200 text-slate-700 text-sm font-medium rounded-lg hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent transition-colors focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 flex items-center justify-center gap-2"
          >
