...
export const ExercisesWidget = memo(function ExercisesWidget({
  ...
  if (size === 'mini') {
    return (
      <Link
        to="/exercises"
        className="group flex items-center gap-3 bg-white dark:bg-stone-900 p-3 rounded-xl border border-stone-200 dark:border-stone-700 hover:border-emerald-300 dark:hover:border-emerald-600 hover:shadow-md transition-all duration-200"
      >
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-stone-800 dark:text-stone-100">{t('exercisesWidget.exercises')}</p>
          <p className="text-xs text-stone-700 dark:text-stone-400">{completedCount}/{totalExercises}</p>
        </div>
        {streakDays > 0 && (
  ...
  if (size === 'medium') {
    return (
      <Link
        to="/exercises"
        className="group block bg-white dark:bg-stone-900 p-4 rounded-xl border border-stone-200 dark:border-stone-700 hover:border-emerald-300 dark:hover:border-emerald-600 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200"
      >
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-semibold text-stone-800 dark:text-stone-100 text-sm">{t('exercisesWidget.exercises')}</h3>
              <p className="text-xs text-stone-700 dark:text-stone-400">{t('exercisesWidget.trainSkills')}</p>
            </div>
          </div>
          <ChevronRight size={16} className="text-stone-300 dark:text-stone-400 group-hover:text-emerald-500 dark:group-hover:text-emerald-400 transition-colors" />
        </div>

        <div className="flex items-center gap-3">
          <span className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{completedCount}</span>
          <span className="text-sm text-stone-700 dark:text-stone-400">/ {totalExercises}</span>
  ...
  return (
    <Link
      to="/exercises"
      className="group block bg-white dark:bg-stone-900 p-5 rounded-xl border border-stone-200 dark:border-stone-700 hover:border-emerald-300 dark:hover:border-emerald-600 hover:shadow-lg transition-all duration-200"
    >
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-stone-800 dark:text-stone-100">{t('exercisesWidget.exercises')}</h3>
            <p className="text-sm text-stone-700 dark:text-stone-400">{t('exercisesWidget.trainToBetter')}</p>
          </div>
        </div>
        {streakDays > 0 && (
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-stone-600 dark:text-stone-400">{t('exercisesWidget.yourProgress')}</span>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-stone-800 dark:text-stone-100">{completedCount}</span>
          </div>
          <p className="text-xs text-stone-700 dark:text-stone-400">{t('exercisesWidget.completed')}</p>
        </div>
        <div className="p-3 bg-stone-50 dark:bg-stone-700/50 rounded-lg">
          <div className="flex items-center gap-2">
            <Dumbbell size={16} className="text-stone-700 dark:text-stone-400" />
            <span className="text-lg font-bold text-stone-800 dark:text-stone-100">{totalExercises - completedCount}</span>
          </div>
          <p className="text-xs text-stone-700 dark:text-stone-400">{t('exercisesWidget.remaining')}</p>
        </div>
      </div>
