...
const SWEDISH_MUNICIPALITIES = [
  ...
  { concept_id: 'bastad', label: 'Båstad' },
  { concept_id: 'dals-ed', label: 'Dals-Ed' },
  ...
  { concept_id: 'fargelanda', label: 'Färgelanda' },
  { concept_id: 'gagnef', label: 'Gagnef' },
  ...
  { concept_id: 'kavlinge', label: 'Kävlinge' },
  ...
  { concept_id: 'lindesberg', label: 'Lindesberg' },
  ...
  { concept_id: 'morbylanga', label: 'Mörbylånga' },
  ...
  { concept_id: 'vansbro', label: 'Vansbro' },
  { concept_id: 'vanersborg', label: 'Vänersborg' },
  { concept_id: 'vargarda', label: 'Vårgårda' },
