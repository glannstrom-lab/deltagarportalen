          ...
          <Section icon={Users} title={t('privacy.sharing.title')}>
            ...
            <div className="mt-4 p-4 bg-stone-50 dark:bg-stone-700/30 rounded-lg border border-stone-200 dark:border-stone-700">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li><a href="https://openrouter.ai/terms" target="_blank" rel="noopener noreferrer" className="text-[var(--c-text)] hover:underline inline-flex items-center gap-1">OpenRouter Terms <ExternalLink className="w-3 h-3" /></a> <span className="text-stone-500">— {t('privacy.sharing.dpaOpenRouterNote')}</span></li>
                <li><a href="https://sentry.io/legal/dpa/" target="_blank" rel="noopener noreferrer" className="text-[var(--c-text)] hover:underline inline-flex items-center gap-1">Sentry DPA <ExternalLink className="w-3 h-3" /></a> <span className="text-stone-500">— {t('privacy.sharing.dpaSentryNote')}</span></li>
