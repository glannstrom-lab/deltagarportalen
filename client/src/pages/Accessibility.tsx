      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <header className="mb-8">
          ...
          <p className="text-stone-600 dark:text-stone-400">
            Sidan senast redigerad: 2026-08-12
          </p>
          <p className="text-stone-600 dark:text-stone-400">
            Bedömningen bygger på en granskning genomförd: 2026-08-09
          </p>
        </header>
        ...
        <div className="bg-white dark:bg-stone-800 rounded-2xl shadow-sm p-8 space-y-8">
          ...
          <Section icon={AlertTriangle} title="Kända brister">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              <li className="flex gap-2"><AlertTriangle className="w-4 h-4 mt-1 text-amber-600 flex-shrink-0" /><span><strong>Skip-länken syns inte:</strong> Länken "Hoppa till huvudinnehåll" finns och fungerar för skärmläsare, men blir aldrig synlig på skärmen när den får tangentbordsfokus. Den som navigerar med tangentbord utan skärmläsare ser inte att genvägen finns.</span></li>
              <li className="flex gap-2"><AlertTriangle className="w-4 h-4 mt-1 text-amber-600 flex-shrink-0" /><span><strong>Mobilmenyn och tangentbord:</strong> På mobil och vid hög förstoring (400 %) ligger ett stort antal osynliga menyelement kvar i tabbordningen även när menyn är stängd — du kan behöva trycka tangentbordets Tab-tangent många gånger innan du når sidans innehåll.</span></li>
              <li className="flex gap-2"><AlertTriangle className="w-4 h-4 mt-1 text-amber-600 flex-shrink-0" /><span><strong>Vissa knappar saknar namn för skärmläsare:</strong> Bland annat några ikonknappar på mobil (dagbokens flikar, CV-verktyget) och ett fåtal på desktop (t.ex. att radera ett dagboksinlägg) läses upp bara som "knapp" utan att säga vad den gör.</span></li>
              ...
              <li className="flex gap-2"><AlertTriangle className="w-4 h-4 mt-1 text-amber-600 flex-shrink-0" /><span><strong>Registreringsformuläret:</strong> Felmeddelanden vid ogiltig e-post eller för kort lösenord visas på skärmen men är inte kopplade till fälten för skärmläsare — de når inte fram till den som inte ser texten.</span></li>
          ...
          <div className="border-t border-stone-200 dark:border-stone-700 pt-4 text-sm text-stone-500 dark:text-stone-400">
            <p>Denna redogörelse upprättades ursprungligen 2026-05-15 enligt EU:s tillgänglighetsdirektiv (2019/882) och svensk lag (2023:254), och skrevs om 2026-08-12 för att stämma med den interna granskningen från 2026-08-09 — se "Hur bedömningen är gjord" ovan. Vi uppdaterar redogörelsen vid varje större granskning, minst årligen.</p>
          </div>
