...
import { staWorkplacesApi } from '@/services/staApi'
import { useAuthStore } from '@/stores/authStore'
import { staEnrollmentsApi } from '@/services/staApi'
import { DOC_TYPE_META } from '@/services/staAiApi'
import { toParticipantRow, computeKpi, formatShortDate, resolveParticipantName, deriveCurrentPart, PART_COLORS, type EnrollmentStats } from './enrollmentDisplay'
import {
...
/**
 * I4 (2026-07-27): filen var 4 416 rader. Flikarna, modalerna och de delade
 * småkomponenterna är utbrutna till ./consultant/ längs de sektionsgränser som
 * redan fanns markerade i filen. Kvar här är huvudkomponenten, sidchromet
 * (hero/KPI/flikar), Översikt-fliken, Deltagar-fliken och detaljlådan.
 *
 * Konsulentvyn i18n:as INTE — DESIGN.md §2 tillåter annan ton i konsulent- och
 * adminvyer, och F9 undantog dem medvetet från i18n-svepet. Uppdelningen är
 * därför en ren strukturell åtgärd utan textändringar.
 */
import { PartChip } from './consultant/PartChip'
import { EditEnrollmentModal } from './consultant/EditEnrollmentModal'
import { AssessmentsTab } from './consultant/AssessmentsTab'
import { ASSESSMENT_ITEM_COUNT, type Instrument } from './consultant/tableTypes'
import { WorkplacesTab } from './consultant/WorkplacesTab'
import { DocumentsTab } from './consultant/DocumentsTab'
import { AddParticipantModal, LinkParticipantModal } from './consultant/ParticipantModals'
import { formatAbsenceDate, labelForAbsenceKind } from './consultant/absenceLabels'
