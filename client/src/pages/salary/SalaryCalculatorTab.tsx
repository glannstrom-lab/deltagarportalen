            ...
            <Card className="border-[var(--c-accent)]/60 dark:border-[var(--c-accent)]/50 bg-[var(--c-bg)]/50 dark:bg-[var(--c-bg)]/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-white dark:bg-stone-700 rounded-xl p-4 border-2 border-[var(--c-accent)] dark:border-[var(--c-solid)] shadow-sm">
                  <p className="text-sm text-[var(--c-text)] dark:text-[var(--c-solid)] font-medium mb-1">{t('salary.calculator.medianRecommended')}</p>
                  <p className="text-3xl font-bold text-[var(--c-text)] dark:text-[var(--c-accent)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-white dark:bg-stone-700 rounded-xl p-4 border border-[var(--c-accent)]/40 dark:border-[var(--c-accent)]/50">
                  ...
                  <p className="text-xl font-bold text-[var(--c-text)] dark:text-[var(--c-solid)]">+{calculatedSalary.growth}%</p>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="h-2 bg-stone-100 dark:bg-stone-600 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-[var(--c-solid)]/80 dark:bg-[var(--c-solid)]"
              ...
              {showTaxDetail && (
                <motion.div
                  ...
                  className="bg-[var(--c-bg)] dark:bg-[var(--c-bg)]/20 rounded-xl p-4 border border-[var(--c-accent)]/40 dark:border-[var(--c-accent)]/50 mb-4"
                >
                  <div className="flex items-start gap-3">
                    <PieChart className="w-5 h-5 text-[var(--c-text)] dark:text-[var(--c-solid)] shrink-0 mt-0.5" />
                    <div className="text-sm text-[var(--c-text)] dark:text-[var(--c-text)]">
              ...
              {/* Info box */}
              <div className="flex items-start gap-3 p-4 bg-[var(--c-bg)] dark:bg-[var(--c-bg)]/20 rounded-xl border border-[var(--c-accent)]/40 dark:border-[var(--c-accent)]/50">
                <Info className="w-5 h-5 text-[var(--c-text)] dark:text-[var(--c-solid)] shrink-0 mt-0.5" />
                <div className="text-sm text-[var(--c-text)] dark:text-[var(--c-text)]">
                  ...
                  <div className="mt-3 pt-3 border-t border-sky-100 dark:border-sky-800">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className={cn(
                        ...
                        comp.gross > calculatedSalary.median ? 'text-[var(--c-text)] dark:text-[var(--c-solid)]' : 'text-gray-700 dark:text-gray-300'
                      )}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex items-start gap-3 p-3 bg-stone-50 dark:bg-stone-700 rounded-lg">
            <div className="w-8 h-8 bg-[var(--c-accent)]/40 dark:bg-[var(--c-bg)]/30 rounded-lg flex items-center justify-center shrink-0">
              <span className="text-[var(--c-text)] dark:text-[var(--c-solid)] font-bold">1</span>
            </div>
            <div>
          ...
          <div className="flex items-start gap-3 p-3 bg-stone-50 dark:bg-stone-700 rounded-lg">
            <div className="w-8 h-8 bg-[var(--c-accent)]/40 dark:bg-[var(--c-bg)]/30 rounded-lg flex items-center justify-center shrink-0">
              <span className="text-[var(--c-text)] dark:text-[var(--c-solid)] font-bold">2</span>
            </div>
            <div>
          ...
          <div className="flex items-start gap-3 p-3 bg-stone-50 dark:bg-stone-700 rounded-lg">
            <div className="w-8 h-8 bg-[var(--c-accent)]/40 dark:bg-[var(--c-bg)]/30 rounded-lg flex items-center justify-center shrink-0">
              <span className="text-[var(--c-text)] dark:text-[var(--c-solid)] font-bold">3</span>
            </div>
            <div>
          ...
          <div className="flex items-start gap-3 p-3 bg-stone-50 dark:bg-stone-700 rounded-lg">
            <div className="w-8 h-8 bg-[var(--c-accent)]/40 dark:bg-[var(--c-bg)]/30 rounded-lg flex items-center justify-center shrink-0">
              <span className="text-[var(--c-text)] dark:text-[var(--c-solid)] font-bold">4</span>
            </div>
            <div>
