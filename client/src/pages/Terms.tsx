    ...
    <div className="min-h-screen bg-stone-50 dark:bg-stone-900 page-transition">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="bg-white dark:bg-stone-800 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-700 p-8 lg:p-12 space-y-10">
          ...
          {/* AG4 (2026-09-01) — omskriven FÖRE första raden kod i arbetsgivarspåret.
              Ordningen är inte kosmetisk: dagens lydelse ("arbetsgivare får inte
              utvärdera, screena eller jämföra externa kandidater") är den NAMNGIVNA
              mitigeringen som håller fyra AI-funktioner utanför högriskklassning i
              `docs/AI-ACT-CLASSIFICATION.md`, och den bär DPIA:ns R9. Att ta bort den
              för att släppa in företag hade rivit riskbedömningen samtidigt.

              Därför är förbudet SKÄRPT, inte lättat. Det som tillkommit säger vad ett
              företagskonto aldrig får göra — söka, filtrera, rangordna, jämföra, eller
              få se AI-resultat om en person — och att det alltid är en människa som
              väljer vem som föreslås. Det är precis den gränsen som håller portalen i
              lågrisk enligt Annex III 4(a).

              Formuleringarna är villkorade ("om portalen ger ett företag ett konto"),
              eftersom företagskonton INTE finns i dag. Villkoren ska beskriva vad som
              gäller, inte lova en funktion.

              Juridisk genomläsning kvarstår — se ROADMAP A2. */}
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center gap-3">
              <Shield className="w-5 h-5 text-[var(--c-text)] dark:text-[var(--c-text)]" />
              {t('terms.noScreening.title')}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-3">
              {t('terms.noScreening.intro')}
            </p>
            <ul className="space-y-2 text-gray-600 dark:text-gray-300">
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-[var(--c-solid)] dark:bg-[var(--c-solid)] rounded-full mt-2 flex-shrink-0" />
                <span>{t('terms.noScreening.noSearch')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-[var(--c-solid)] dark:bg-[var(--c-solid)] rounded-full mt-2 flex-shrink-0" />
                <span>{t('terms.noScreening.proposalOnly')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-[var(--c-solid)] dark:bg-[var(--c-solid)] rounded-full mt-2 flex-shrink-0" />
                <span>{t('terms.noScreening.noAiRanking')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-[var(--c-solid)] dark:bg-[var(--c-solid)] rounded-full mt-2 flex-shrink-0" />
                <span>{t('terms.noScreening.noAiOutput')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-[var(--c-solid)] dark:bg-[var(--c-solid)] rounded-full mt-2 flex-shrink-0" />
                <span>{t('terms.noScreening.scraping')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-[var(--c-solid)] dark:bg-[var(--c-solid)] rounded-full mt-2 flex-shrink-0" />
                <span>{t('terms.noScreening.thirdParty')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-1.5 h-1.5 bg-[var(--c-solid)] dark:bg-[var(--c-solid)] rounded-full mt-2 flex-shrink-0" />
                <span>{t('terms.noScreening.discrimination')}</span>
              </li>
            </ul>
            <p className="mt-3 text-gray-600 dark:text-gray-300 leading-relaxed">
              {t('terms.noScreening.consequence')}
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center gap-3">
              ...
              {t('terms.notHealthcare.title')}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              {t('terms.notHealthcare.text')}
            </p>
          </section>
