...
- **Lagringstider = b (2026-09-12).** Alla "bekräftas"-perioder bekräftade som de stod, utom konsulentjournalen som sätts till **5 år efter avslutat uppdrag** (Mikael angav ingen tid; rekommendationen antogs — ändra i RETENTION-POLICY om annat). Att bygga: gallringsjobb för de nio raderna, torrkörning först, i en migration. Avstämning med AI-jurist (A2) kan justera nedåt i efterhand.
