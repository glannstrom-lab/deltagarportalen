...
| A14 | `npm audit fix` i client/ | ✅ **Klar 2026-07-23 (3 av 4)** — dompurify 3.4.12, react-router-dom 7.18.1, ws 8.21.1; 710 tester + build gröna. **Rest:** undici@5.28.4 sitter fast i `@vercel/blob@0.27` — kräver major-uppgradering av @vercel/blob (påverkar upload-image.js); tills dess behåller CI-audit `continue-on-error` (dokumenterat i ci.yml) | Claude |
